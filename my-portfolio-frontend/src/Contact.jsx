...
import { FaWhatsapp, FaLinkedin, FaGithub, FaTwitter, FaTiktok, FaHeart } from 'react-icons/fa';
...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://portfolio-backend-3zx5.onrender.com/api/contact', {
        method: 'POST',
        headers: {
  ...
  const socialLinks = [
    {
      ...
      url: 'https://wa.me/+254718473096',
      color: 'bg-green-500 hover:bg-green-600'
    },
    {
      name: 'LinkedIn',
      icon: <FaLinkedin className="text-2xl" />,
      url: 'https://www.linkedin.com/in/cyrus-mwangi-5b2128141/',
      color: 'bg-blue-600 hover:bg-blue-700'
    },
    {
      name: 'GitHub',
      icon: <FaGithub className="text-2xl" />,
      url: 'https://github.com/Cyrusson',
      color: 'bg-gray-800 hover:bg-gray-900'
    },
    {
      name: 'Twitter',
      icon: <FaTwitter className="text-2xl" />,
      url: 'https://x.com/realCyrusMwangi',
      color: 'bg-blue-400 hover:bg-blue-500'
    },
    {
      name: 'TikTok',
      icon: <FaTiktok className="text-2xl" />,
      url: 'https://www.tiktok.com/@mwangicyrus',
    ...
    <>
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:realcyrusmwangi@gmail.com" className="hover:text-blue-300 transition">realcyrusmwangi@gmail.com</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:+254718473096" className="hover:text-blue-300 transition">+254 (718) 473-096</a>
                    </div>
                  </div>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <p className="flex items-center justify-center md:justify-start text-blue-200">
                © {new Date().getFullYear()} Cyrus Mwangi. Made with 
          ...
          <motion.div 
            className="mt-6 pt-6 border-t border-gray-700 text-center text-sm text-blue-200"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 1.1, duration: 0.5 }}
          >
            <p>Designed and developed with passion. All rights reserved.</p>
          </motion.div>
        </div>
      </motion.footer>
    </>
