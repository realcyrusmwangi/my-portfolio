...
const ProjectModal = ({ project, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
      ...
      <motion.div
        ref={modalRef}
        className="relative bg-gray-800 rounded-xl shadow-2xl border border-gray-700 overflow-hidden w-full max-w-4xl max-h-[90vh] overflow-y-auto z-60"
...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute inset-0 bg-gradient-to-br from-gray-900/90 to-blue-900/80"
        style={{ zIndex: 1 }}
      />
              ...
              <div className="flex-1 p-4 sm:p-6 bg-gradient-to-b from-gray-800/90 to-gray-900/90 flex flex-col">
                ...
                <div className="mt-auto">
                  <button
                    ...
                    style={{ 
                      minHeight: '44px',
                      // Force the button to be above any overlays
                      position: 'relative',
                      zIndex: 40
                    }}
                  >
